...
function HeaderImage({customBackground}) {
  return (
    ...
    <img src={`${customBackground ? customBackground : 'https://wallpaperaccess.com/full/388706.jpg'}`} alt='sub-image' className='nav-image'/>
    </div>
  )
}
